...
def create_logo_background(png_path):
    canvas = Image.new("RGBA", (512, 512), (0, 0, 0, 0))
    draw = ImageDraw.Draw(canvas)
    draw.rounded_rectangle((0, 0, 512, 512), radius=96, fill=(0, 0, 0, 255))
    canvas.save(png_path)
    print(f"Generated: {png_path} (black rounded background)")
...
if __name__ == "__main__":
    ...
    create_logo_background(os.path.join(base_dir, "logo_background.png"))
